...
Storage: Why I chose dir is because this was purely for testing and non-production demonstration, zfs was sadly not available, it would have been more efficient and faster.

Networking: Implementing a managed Bridge (lxdbr0) with custom DHCP ranges.


Section 3: Incident Report (The 'Compelling Narrative' part)
...
3. 3. Used journalctl -xe on the host to check for bridge errors.
